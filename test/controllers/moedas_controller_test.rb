...
class MoedasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moeda" do
    assert_difference('Moeda.count') do
      post moedas_url, params: { moeda: { imagem: @moeda.imagem, nome: @moeda.nome, sigla: @moeda.sigla } }
    end
  ...
  test "should update moeda" do
    patch moeda_url(@moeda), params: { moeda: { imagem: @moeda.imagem, nome: @moeda.nome, sigla: @moeda.sigla } }
